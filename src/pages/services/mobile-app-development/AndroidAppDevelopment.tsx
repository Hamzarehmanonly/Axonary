...
const services = [
  {
    ...
    desc:
      "Axonary delivers high-performance native Android apps built in Kotlin and Java. Our Android app development services help you launch fast, stable, and scalable products that stand out on Google Play.",
  ...
  },
  {
    ...
    desc:
      "Material Design 3 brought to life with thoughtful UI, fluid motion, and a user-first approach. We ensure your Android app is modern, intuitive, and effortless to navigate.",
  ...
  },
  {
    ...
    desc:
      "From API integration to real-time sync, we build backend systems that keep your Android app fast, secure, and ready for scale—no matter how many users you have.",
  ...
  },
  {
    ...
    desc:
      "We test your Android app across devices, screen sizes, and OS versions to ensure every release is stable, fast, and ready for real users.",
  ...
  >
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#native-android" className="hover:text-white">Overview</a>
        <a href="#android-ui" className="hover:text-white">UI</a>
...
const FAQS = [
  ...
  {
    q: "Can you migrate my existing app to Android?",
  ...
  {
    q: "Will my app work on all Android devices?",
  ...
  },
  {
    ...
    a: "We blend Google-certified expertise, creative UI/UX, and relentless support. Our Android apps don’t just work—they win users and drive growth.",
  },
];
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mt-12 text-center">
          <a href="/contact" className="px-5 py-3 rounded-full font-medium shadow-lg" style={{ background: COLORS.primary, color: COLORS.white, minWidth: 140, textAlign: 'center', fontFamily: 'inherit', fontSize: '1rem' }}>
            Still have questions? Ask our Android experts
          </a>
        </div>
      </div>
    </section>
...
const TESTIMONIALS = [
  {
    ...
    quote: "Axonary’s Android team delivered our app ahead of schedule. The quality and performance are outstanding. Highly recommended!",
              ...
              <div className="md:col-span-6 flex flex-col items-center justify-center">
                <div className="max-w-xl w-full">
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <a href={`/${id}`} className="px-4 py-2 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white, minWidth: 140, textAlign: 'center' }}>
                      Learn More
                    </a>
                    <a href="/contact" className="px-4 py-2 rounded-full border border-[rgba(255,255,255,0.06)] font-semibold" style={{ color: COLORS.textMuted, minWidth: 140, textAlign: 'center' }}>
                      Get Started
  ...
  <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-[92%] md:w-[720px]">
    ...
    >
      <div>
        ...
        <div className="text-xs" style={{ color: COLORS.textMuted }}>Let’s create a high-performance Android app together.</div>
      </div>
      <div className="flex items-center gap-3">
