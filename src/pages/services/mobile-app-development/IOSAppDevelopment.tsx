...
/**
 * IOSAppDevelopment.tsx
 * Interactive Split (Dribbble-style) — iOS App Development Services
 *
 * Notes:
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between h-16">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
          <a href="#native-ios" className="hover:text-white">Native</a>
          <a href="#ios-ui" className="hover:text-white">UI Design</a>
    ...
    <div style={{ background: COLORS.bg, color: COLORS.white, minHeight: "100vh" }}>
      ...
      <footer className="mt-20 py-10">
        <div className="container mx-auto px-6 text-center text-sm" style={{ color: COLORS.textMuted }}>
          © {new Date().getFullYear()} Axonary — iOS Excellence. Always.
        </div>
      </footer>
    </div>
  );
