...
import { mobileGovernanceIOS } from "../../../data/mobileServiceGovernanceContent";
...
const FAQS = [
  ...
  },
  {
    ...
    a: "We combine native iOS engineering, thoughtful UI/UX, and structured delivery. Our goal is apps that are stable in review, maintainable in code, and aligned to your roadmap.",
  },
];
  ...
  return (
    <div style={{ background: COLORS.bg, color: COLORS.white, minHeight: "100vh" }}>
      ...
      <main className="pt-20">
        <MobileServiceHero colors={COLORS} hero={mobileGovernanceIOS.hero} />
        <MobileServiceGovernanceSections colors={COLORS} copy={mobileGovernanceIOS} />
        <div className="mt-8">
          {services.map((s, idx) => (
        ...
        <section className="mt-12">
          <div className="container mx-auto px-6 text-center py-8 rounded-2xl shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4" style={{ color: COLORS.primary, letterSpacing: '-1px' }}>
              Ready to take your iOS product to the App Store?
            </h2>
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Share your roadmap, integrations, and compliance context—we will propose discovery, phases, testing, and a submission plan that matches your timeline.
            </p>
