...
const services = [
  {
    ...
    desc:
      "Axonary delivers world-class Flutter app development for startups and enterprises. Our expert team builds blazing-fast, visually stunning, and scalable cross-platform apps from a single codebase—helping you reach iOS and Android users with one launch.",
  ...
  },
  {
    ...
    desc:
      "Our Flutter mobile app development services help you ship polished iOS and Android apps faster, with a single, scalable codebase and native performance.",
  ...
  },
  {
    ...
    desc:
      "Hire Flutter app developers from Axonary and work with a focused team that owns your product, your timelines, and your technical decisions. We become your true technology partner.",
  ...
  },
  {
    ...
    desc:
      "As a Flutter app development agency, we deliver smooth UI, fast performance, and consistent experiences across platforms—without the headaches of native development.",
  ...
  },
  {
    ...
    desc:
      "From framework updates to feature enhancements, our team handles Flutter app maintenance so your product stays stable, secure, and current.",
  ...
  },
  {
    ...
    desc:
      "Flutter mobile app development reduces time and cost by using one codebase, making it a smart choice for startups and enterprises focused on ROI.",
...
const FAQS = [
  ...
  {
    q: "Can you migrate my existing app to Flutter?",
  ...
  {
    q: "Will my Flutter app work on all iOS and Android devices?",
  ...
  },
  {
    ...
    a: "We blend Flutter expertise, creative UI/UX, and relentless support. Our Flutter apps don't just work—they win users and drive growth.",
  },
];
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mt-12 text-center">
          <a href="/contact" className="px-5 py-3 rounded-full font-medium shadow-lg" style={{ background: COLORS.primary, color: COLORS.white, minWidth: 140, textAlign: 'center', fontFamily: 'inherit', fontSize: '1rem' }}>
            Still have questions? Ask our Flutter experts
          </a>
        </div>
      </div>
    </section>
...
const TESTIMONIALS = [
  {
    ...
    quote: "Axonary's Flutter team delivered our app ahead of schedule. The quality and performance are outstanding. Highly recommended!",
  ...
  >
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#flutter-app-development" className="hover:text-white">Overview</a>
        <a href="#cross-platform-speed" className="hover:text-white">Speed</a>
        <a href="#dedicated-flutter-developers" className="hover:text-white">Team</a>
        <a href="#high-performance-apps" className="hover:text-white">Performance</a>
        <a href="#smooth-deployment" className="hover:text-white">Deployment</a>
        <a href="#ongoing-maintenance" className="hover:text-white">Maintenance</a>
        <a href="#cost-efficient-builds" className="hover:text-white">Cost</a>
...
const MobilePhoneMockup: React.FC<{ image: string; title: string; id: string }> = ({ image, title, id }) => {
  function renderUniqueScreen() {
    switch (id) {
        ...
        return (
          <div className="flex-1 flex flex-col gap-3 px-4 py-4 overflow-y-auto">
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex flex-col gap-2 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#5C3693] flex items-center justify-center text-white font-bold text-lg">ND</div>
                <div>
                  <div className="text-gray-900 font-semibold text-sm">Native Android</div>
                  <div className="text-gray-500 text-xs">Kotlin & Java</div>
                </div>
              </div>
              <div className="text-gray-700 text-xs mt-2">High-performance, stable, and scalable Android apps for Google Play.</div>
            ...
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex items-center gap-3 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-[#472A71] flex items-center justify-center text-white font-bold text-lg">PL</div>
              <div className="flex-1">
                <div className="text-gray-900 font-semibold text-sm">Play Store</div>
                <div className="text-gray-500 text-xs">Ready for launch</div>
              </div>
              <div className="w-3 h-3 rounded-full bg-green-400" />
            </div>
          </div>
        );
      case "cross-platform-speed":
        return (
          <div className="flex-1 flex flex-col gap-3 px-4 py-4 overflow-y-auto">
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex flex-col gap-2 shadow-sm border border-[#e5e7eb]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-gray-900 font-semibold text-sm">Material Design 3</div>
                  <div className="text-gray-500 text-xs">Modern & Intuitive</div>
                </div>
              </div>
              <div className="text-gray-700 text-xs mt-2">Fluid motion, user-first approach, and effortless navigation.</div>
              <div className="flex gap-2 mt-2">
      ...
      case "dedicated-flutter-developers":
        return (
          <div className="flex-1 flex flex-col gap-3 px-4 py-4 overflow-y-auto">
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex flex-col gap-2 shadow-sm">
              <div className="flex items-center gap-3">
              ...
              <div className="text-gray-700 text-xs mt-2">Fast, secure, and scalable backend for your Android app.</div>
              <div className="flex gap-2 mt-2">
        ...
        return (
          <div className="flex-1 flex flex-col gap-3 px-4 py-4 overflow-y-auto">
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex flex-col gap-2 shadow-sm border border-[#e5e7eb]">
              ...
              <div className="text-gray-700 text-xs mt-2">Tested across devices, screen sizes, and OS versions.</div>
              <div className="flex gap-2 mt-2">
            ...
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex items-center gap-3 shadow-sm">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-500 text-xs">All Androids</div>
              </div>
              <div className="w-3 h-3 rounded-full bg-blue-400" />
            </div>
          </div>
        );
      case "smooth-deployment":
        return (
          <div className="flex-1 flex flex-col gap-3 px-4 py-4 overflow-y-auto">
            <div className="bg-[#f3f4f6] rounded-xl p-4 flex flex-col gap-2 shadow-sm">
              <div className="flex items-center gap-3">
              ...
              <div className="text-gray-700 text-xs mt-2">Frame-rate smoothing, resource handling, and more.</div>
              <div className="flex gap-2 mt-2">
  ...
  <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-[92%] md:w-[720px]">
    ...
    >
      <div>
        ...
        <div className="text-xs" style={{ color: COLORS.textMuted }}>Let’s create beautiful, high-performance apps together.</div>
      </div>
      <div className="flex items-center gap-3">
