...
import { NodeJsSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "api-development", title: "RESTful API Development", desc: "Build high-performance APIs with Express.js, Fastify, and modern Node.js frameworks." },
  { id: "real-time-applications", title: "Real-time Applications", desc: "Create real-time apps with Socket.io, WebSockets, and event-driven architectures." },
  { id: "microservices", title: "Microservices Architecture", desc: "Design scalable microservices using Node.js, Docker, and cloud-native technologies." },
  { id: "serverless-functions", title: "Serverless Functions", desc: "Deploy serverless functions with AWS Lambda, Vercel, and Netlify for optimal performance." },
  { id: "full-stack-development", title: "Full-Stack Development", desc: "Build complete applications with Node.js backend and modern frontend frameworks integration." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      <div className="flex items-center gap-3">
        ...
        <div><div className="text-sm font-bold" style={{ color: COLORS.white }}>Axonary</div><div className="text-xs" style={{ color: COLORS.textMuted }}>Node.js Development</div></div>
      </div>
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#api-development" className="hover:text-white">APIs</a><a href="#real-time-applications" className="hover:text-white">Real-time</a><a href="#microservices" className="hover:text-white">Microservices</a><a href="#serverless-functions" className="hover:text-white">Serverless</a><a href="#full-stack-development" className="hover:text-white">Full-Stack</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Fast • Scalable • Event-Driven</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Node.js <span style={{ color: COLORS.primary }}>Power</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Build lightning-fast, scalable server-side applications with JavaScript's most powerful runtime environment.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#api-development" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Services</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><NodeJsSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<NodeJsSVG width={360} height={360} />, <NodeJsSVG width={360} height={360} />, <NodeJsSVG width={360} height={360} />, <NodeJsSVG width={360} height={360} />, <NodeJsSVG width={360} height={360} />][idx];
