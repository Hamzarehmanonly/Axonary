...
import { BingSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "bing-ads", title: "Bing Ads Management", desc: "Create effective search advertising campaigns on Microsoft Advertising with lower competition and costs." },
  { id: "microsoft-advertising", title: "Microsoft Advertising Platform", desc: "Leverage Microsoft's advertising ecosystem including LinkedIn, MSN, and partner networks for reach." },
  { id: "search-optimization", title: "Bing Search Optimization", desc: "Optimize your content for Bing search algorithms and improve visibility on Microsoft's search engine." },
  { id: "audience-targeting", title: "Advanced Audience Targeting", desc: "Utilize Microsoft's unique audience data and LinkedIn integration for precise B2B targeting." },
  { id: "conversion-tracking", title: "Conversion Tracking & Analytics", desc: "Implement comprehensive tracking and analytics to measure campaign performance and ROI." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      <div className="flex items-center gap-3">
        ...
        <div><div className="text-sm font-bold" style={{ color: COLORS.white }}>Axonary</div><div className="text-xs" style={{ color: COLORS.textMuted }}>Bing Solutions</div></div>
      </div>
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#bing-ads" className="hover:text-white">Bing Ads</a><a href="#microsoft-advertising" className="hover:text-white">Microsoft</a><a href="#search-optimization" className="hover:text-white">SEO</a><a href="#audience-targeting" className="hover:text-white">Targeting</a><a href="#conversion-tracking" className="hover:text-white">Analytics</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Search • Professional • Results-Driven</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Bing <span style={{ color: COLORS.primary }}>Advantage</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Unlock the potential of Microsoft's search ecosystem with targeted advertising and optimization strategies.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#bing-ads" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Services</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><BingSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<BingSVG width={360} height={360} />, <BingSVG width={360} height={360} />, <BingSVG width={360} height={360} />, <BingSVG width={360} height={360} />, <BingSVG width={360} height={360} />][idx];
