...
import { OracleSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "database-solutions", title: "Oracle Database Solutions", desc: "Implement robust enterprise databases with Oracle's industry-leading relational database management system." },
  { id: "cloud-infrastructure", title: "Oracle Cloud Infrastructure", desc: "Deploy scalable applications on Oracle's enterprise-grade cloud platform with autonomous database capabilities." },
  { id: "enterprise-applications", title: "Enterprise Applications", desc: "Integrate Oracle ERP, HCM, CX, and SCM applications for comprehensive business process management." },
  { id: "data-analytics", title: "Oracle Analytics Cloud", desc: "Build powerful business intelligence solutions with Oracle's comprehensive analytics and reporting platform." },
  { id: "middleware-integration", title: "Middleware & Integration", desc: "Connect systems seamlessly with Oracle Fusion Middleware and enterprise integration patterns." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      <div className="flex items-center gap-3">
        ...
        <div><div className="text-sm font-bold" style={{ color: COLORS.white }}>Axonary</div><div className="text-xs" style={{ color: COLORS.textMuted }}>Oracle Solutions</div></div>
      </div>
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#database-solutions" className="hover:text-white">Database</a><a href="#cloud-infrastructure" className="hover:text-white">Cloud</a><a href="#enterprise-applications" className="hover:text-white">Enterprise</a><a href="#data-analytics" className="hover:text-white">Analytics</a><a href="#middleware-integration" className="hover:text-white">Middleware</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Enterprise • Reliable • Mission-Critical</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Oracle <span style={{ color: COLORS.primary }}>Enterprise</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Power your enterprise with Oracle's comprehensive suite of database, cloud, and application solutions.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#database-solutions" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Services</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><OracleSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<OracleSVG width={360} height={360} />, <OracleSVG width={360} height={360} />, <OracleSVG width={360} height={360} />, <OracleSVG width={360} height={360} />, <OracleSVG width={360} height={360} />][idx];
