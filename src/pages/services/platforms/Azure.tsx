...
import { AzureSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "cloud-migration", title: "Azure Cloud Migration", desc: "Seamlessly migrate your applications and infrastructure to Azure with minimal downtime and optimal performance." },
  { id: "app-services", title: "Azure App Services", desc: "Deploy and scale web apps, APIs, and mobile backends using Azure's fully managed platform service." },
  { id: "devops-solutions", title: "Azure DevOps Solutions", desc: "Implement CI/CD pipelines, automated testing, and deployment strategies with Azure DevOps Services." },
  { id: "data-analytics", title: "Azure Data & Analytics", desc: "Build powerful data solutions using Azure SQL, Cosmos DB, Synapse Analytics, and Power BI integration." },
  { id: "ai-ml-services", title: "Azure AI & ML Services", desc: "Leverage Azure Cognitive Services, Machine Learning, and AI Platform for intelligent applications." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      <div className="flex items-center gap-3">
        ...
        <div><div className="text-sm font-bold" style={{ color: COLORS.white }}>Axonary</div><div className="text-xs" style={{ color: COLORS.textMuted }}>Azure Solutions</div></div>
      </div>
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#cloud-migration" className="hover:text-white">Migration</a><a href="#app-services" className="hover:text-white">App Services</a><a href="#devops-solutions" className="hover:text-white">DevOps</a><a href="#data-analytics" className="hover:text-white">Data</a><a href="#ai-ml-services" className="hover:text-white">AI/ML</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Enterprise • Scalable • Secure</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Azure <span style={{ color: COLORS.primary }}>Excellence</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Transform your business with Microsoft Azure's comprehensive cloud platform and enterprise-grade solutions.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#cloud-migration" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Services</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><AzureSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<AzureSVG width={360} height={360} />, <AzureSVG width={360} height={360} />, <AzureSVG width={360} height={360} />, <AzureSVG width={360} height={360} />, <AzureSVG width={360} height={360} />][idx];
