...
import { PropertyManagementSVG, VirtualToursSVG, RealEstateAnalyticsSVG, RealEstateCrmSVG, RealEstateMarketplaceSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "property", title: "Property Management Systems", desc: "Manage properties, tenants, leases, and maintenance with comprehensive property management software." },
  { id: "virtual", title: "Virtual Tours & 3D Visualization", desc: "Immersive 360° virtual tours, 3D property visualization, and AR/VR experiences." },
  { id: "analytics", title: "Real Estate Analytics", desc: "Market insights, pricing analytics, and investment decision tools powered by data." },
  { id: "crm", title: "Real Estate CRM", desc: "Lead management, client relationships, and sales pipeline tracking for agents and brokers." },
  { id: "marketplace", title: "Real Estate Marketplace Platforms", desc: "Online property listing platforms with advanced search, filters, and mortgage calculators." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#property" className="hover:text-white">Property</a><a href="#virtual" className="hover:text-white">Virtual Tours</a><a href="#analytics" className="hover:text-white">Analytics</a><a href="#crm" className="hover:text-white">CRM</a><a href="#marketplace" className="hover:text-white">Marketplace</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Smart • Immersive • Data-Driven</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Real Estate <span style={{ color: COLORS.primary }}>Innovation</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Transform property management, sales, and customer experiences with cutting-edge technology.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#property" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Solutions</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><PropertyManagementSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<PropertyManagementSVG width={360} height={360} />, <VirtualToursSVG width={360} height={360} />, <RealEstateAnalyticsSVG width={360} height={360} />, <RealEstateCrmSVG width={360} height={360} />, <RealEstateMarketplaceSVG width={360} height={360} />][idx];
