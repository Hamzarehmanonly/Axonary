...
import { POSSolutionsSVG, OmniChannelSVG, CustomerLoyaltySVG, RetailAnalyticsSVG, RetailSupplyChainSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "pos", title: "Point of Sale Solutions", desc: "Modern POS systems with inventory management, customer tracking, and seamless payment processing." },
  { id: "omnichannel", title: "Omnichannel Retail", desc: "Unified shopping experiences across online, mobile, and physical stores with real-time inventory sync." },
  { id: "loyalty", title: "Customer Loyalty Programs", desc: "Build customer engagement with rewards, personalized offers, and data-driven loyalty programs." },
  { id: "analytics", title: "Retail Analytics & Insights", desc: "Sales analytics, customer behavior tracking, and predictive insights for data-driven decisions." },
  { id: "supply-chain", title: "Retail Supply Chain Management", desc: "Optimize inventory, supplier management, and distribution with smart supply chain solutions." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#pos" className="hover:text-white">POS</a><a href="#omnichannel" className="hover:text-white">Omnichannel</a><a href="#loyalty" className="hover:text-white">Loyalty</a><a href="#analytics" className="hover:text-white">Analytics</a><a href="#supply-chain" className="hover:text-white">Supply Chain</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Seamless • Engaging • Profitable</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Retail Solutions <span style={{ color: COLORS.primary }}>That Sell</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Transform retail experiences with smart POS systems, omnichannel commerce, and customer loyalty platforms.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#pos" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Solutions</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><POSSolutionsSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<POSSolutionsSVG width={360} height={360} />, <OmniChannelSVG width={360} height={360} />, <CustomerLoyaltySVG width={360} height={360} />, <RetailAnalyticsSVG width={360} height={360} />, <RetailSupplyChainSVG width={360} height={360} />][idx];
