...
import { PaymentProcessingSVG, DigitalWalletSVG, BlockchainSVG, LendingSVG, InsuranceSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "payments", title: "Payment Processing Platforms", desc: "Secure payment gateways with multi-currency support, fraud detection, and real-time settlements." },
  { id: "wallet", title: "Digital Wallet Solutions", desc: "Mobile wallets, peer-to-peer transfers, and cryptocurrency integration for modern finance." },
  { id: "blockchain", title: "Blockchain & DeFi", desc: "Decentralized finance, smart contracts, and blockchain-based financial solutions." },
  { id: "lending", title: "Digital Lending Platforms", desc: "Automated loan processing, credit scoring, and peer-to-peer lending solutions." },
  { id: "insurance", title: "Insurtech Solutions", desc: "Digital insurance platforms with policy management, claims processing, and risk assessment." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#payments" className="hover:text-white">Payments</a><a href="#wallet" className="hover:text-white">Wallets</a><a href="#blockchain" className="hover:text-white">Blockchain</a><a href="#lending" className="hover:text-white">Lending</a><a href="#insurance" className="hover:text-white">Insurtech</a>
  ...
  <section className="min-h-screen flex items-center pt-20 pb-20" style={{ background: COLORS.bg, color: COLORS.white }}>
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        ...
        <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Fintech Solutions <span style={{ color: COLORS.primary }}>for the Future</span></h1>
        <p className="mt-4 text-lg text-gray-300 max-w-2xl">Build secure financial technology platforms with regulatory compliance, fraud prevention, and seamless UX.</p>
        <div className="mt-6 flex items-center gap-4">
          <a href="#payments" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Solutions</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><PaymentProcessingSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<PaymentProcessingSVG width={360} height={360} />, <DigitalWalletSVG width={360} height={360} />, <BlockchainSVG width={360} height={360} />, <LendingSVG width={360} height={360} />, <InsuranceSVG width={360} height={360} />][idx];
