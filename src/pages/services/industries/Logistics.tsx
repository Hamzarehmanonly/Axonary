...
import { FleetManagementSVG, WarehouseSVG, SupplyChainSVG, DeliverySVG, CustomsSVG } from "../../../components/IndustriesSVGs.js";
...
const services = [
  { id: "fleet", title: "Fleet Management Systems", desc: "Real-time vehicle tracking, route optimization, and driver management for efficient fleet operations." },
  { id: "warehouse", title: "Warehouse Management", desc: "Inventory tracking, order fulfillment, and warehouse automation for streamlined operations." },
  { id: "supply-chain", title: "Supply Chain Optimization", desc: "End-to-end supply chain visibility, demand forecasting, and logistics optimization." },
  { id: "delivery", title: "Last-Mile Delivery Solutions", desc: "Route optimization, real-time tracking, and delivery management for efficient last-mile logistics." },
  { id: "customs", title: "Customs & Compliance Management", desc: "Automated customs documentation, compliance tracking, and international shipping management." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#fleet" className="hover:text-white">Fleet</a><a href="#warehouse" className="hover:text-white">Warehouse</a><a href="#supply-chain" className="hover:text-white">Supply Chain</a><a href="#delivery" className="hover:text-white">Delivery</a><a href="#customs" className="hover:text-white">Customs</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Efficient • Optimized • Connected</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">Logistics <span style={{ color: COLORS.primary }}>Reimagined</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Optimize your logistics operations with AI-powered route planning, real-time tracking, and supply chain visibility.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#fleet" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Solutions</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><FleetManagementSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<FleetManagementSVG width={360} height={360} />, <WarehouseSVG width={360} height={360} />, <SupplyChainSVG width={360} height={360} />, <DeliverySVG width={360} height={360} />, <CustomsSVG width={360} height={360} />][idx];
