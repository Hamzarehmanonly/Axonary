...
import { AutomotiveSoftwareSVG, TelematicsSVG, AutomotiveEcommerceSVG, AdasSVG, EvSolutionsSVG, AutoMaintenanceSVG } from "../../../components/IndustriesSVGs";
...
const services = [
  ...
  },
  {
    ...
    desc: "Real-time vehicle tracking, remote diagnostics, and IoT integration for connected car ecosystems.",
  },
  {
    id: "automotive-ecommerce",
    title: "Automotive E-Commerce Solutions",
    desc: "Online platforms for parts distribution, dealer management, and customer engagement tools.",
  },
  {
    id: "adas",
    title: "ADAS & Autonomous Driving",
    desc: "Advanced driver assistance systems and autonomous vehicle technology development.",
  },
  {
    id: "ev-solutions",
    title: "Electric Vehicle Solutions",
    desc: "EV charging infrastructure, battery management systems, and energy optimization.",
  },
  {
    id: "auto-maintenance",
    title: "Maintenance & Service Platforms",
    desc: "Predictive maintenance, service scheduling, and warranty management systems.",
  },
];
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between h-16">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
          <a href="#automotive-software" className="hover:text-white">Software</a>
          ...
          <a href="#adas" className="hover:text-white">ADAS</a>
          <a href="#ev-solutions" className="hover:text-white">EV Solutions</a>
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7 flex justify-center">
          <div className="text-left">
            <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>
              Innovative • Connected • Future-Ready
            </div>

            <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">
              Automotive Solutions{" "}
              <span style={{ color: COLORS.primary }}>for the Future</span>
            </h1>

            <p className="mt-4 text-lg text-gray-300 max-w-2xl">
              Transform your automotive business with cutting-edge software solutions for connected vehicles, fleet management, and digital experiences.
            </p>

            <div className="mt-6 flex items-center gap-4">
              <a href="#automotive-software" className="px-6 py-3 rounded-full font-semibold inline-flex items-center gap-3" style={{ background: COLORS.primary, color: COLORS.white }}>
                Explore Solutions
              </a>
        ...
        <div className="md:col-span-5">
          <div className="rounded-2xl p-6" style={{ background: COLORS.card }}>
            <AutomotiveSoftwareSVG width={360} height={360} />
          </div>
        </div>
      </div>
    </section>
...
const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  ...
  const getSVGComponent = () => {
    switch(idx) {
      case 0: return <AutomotiveSoftwareSVG width={360} height={360} />;
      case 1: return <TelematicsSVG width={360} height={360} />;
      case 2: return <AutomotiveEcommerceSVG width={360} height={360} />;
      case 3: return <AdasSVG width={360} height={360} />;
      case 4: return <EvSolutionsSVG width={360} height={360} />;
      case 5: return <AutoMaintenanceSVG width={360} height={360} />;
      default: return <AutomotiveSoftwareSVG width={360} height={360} />;
    }
  };
    ...
    <div className="w-full bg-black text-white overflow-x-hidden">
      ...
      <footer className="py-8" style={{ background: COLORS.bg }}>
        <div className="container mx-auto px-6 text-center text-sm" style={{ color: COLORS.textMuted }}>
          © {new Date().getFullYear()} Axonary — Automotive Excellence
        </div>
      </footer>
    </div>
  );
