...
import { SaaSPlatformSVG, APIIntegrationSVG, SubscriptionManagementSVG, SaasAnalyticsSVG, SaasSecuritySVG } from "../../../components/IndustriesSVGs";
...
const services = [
  { id: "platform", title: "SaaS Platform Development", desc: "Build scalable multi-tenant SaaS platforms with user management, billing, and analytics." },
  { id: "api", title: "API & Integration Services", desc: "RESTful APIs, webhooks, and third-party integrations for seamless connectivity." },
  { id: "subscription", title: "Subscription Management", desc: "Flexible billing, usage-based pricing, and automated subscription lifecycle management." },
  { id: "analytics", title: "SaaS Analytics & Reporting", desc: "User behavior tracking, product analytics, and custom reporting dashboards for data-driven decisions." },
  { id: "security", title: "Enterprise Security & Compliance", desc: "SOC 2, GDPR compliance, data encryption, and enterprise-grade security features." },
];
  ...
  <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm" style={{ background: "rgba(0,0,0,0.45)", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
    <div className="container mx-auto px-6 flex items-center justify-between h-16">
      ...
      <nav className="hidden md:flex items-center gap-6 text-sm" style={{ color: COLORS.textMuted }}>
        <a href="#platform" className="hover:text-white">Platform</a><a href="#api" className="hover:text-white">API</a><a href="#subscription" className="hover:text-white">Subscription</a><a href="#analytics" className="hover:text-white">Analytics</a><a href="#security" className="hover:text-white">Security</a>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      <div className="md:col-span-7 flex justify-center">
        <div className="text-left">
          <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>Scalable • Cloud-Native • Reliable</div>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">SaaS Solutions <span style={{ color: COLORS.primary }}>Built to Scale</span></h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl">Launch and scale your SaaS business with enterprise-grade architecture, security, and performance.</p>
          <div className="mt-6 flex items-center gap-4">
            <a href="#platform" className="px-6 py-3 rounded-full font-semibold" style={{ background: COLORS.primary, color: COLORS.white }}>Explore Solutions</a>
      ...
      <div className="md:col-span-5"><div className="rounded-2xl p-6" style={{ background: COLORS.card }}><SaaSPlatformSVG width={360} height={360} /></div></div>
    </div>
  </section>
);

const SplitSection: React.FC<{ idx: number; id: string; title: string; desc: string; }> = ({ idx, id, title, desc }) => {
  const getSVG = () => [<SaaSPlatformSVG width={360} height={360} />, <APIIntegrationSVG width={360} height={360} />, <SubscriptionManagementSVG width={360} height={360} />, <SaasAnalyticsSVG width={360} height={360} />, <SaasSecuritySVG width={360} height={360} />][idx];
