...
const services = [
  {
    id: "on-page",
    title: "On-Page SEO",
    desc: "Optimize every page element including meta tags, headings, content, and images.",
  },
  {
    id: "technical-seo",
    title: "Technical SEO",
    desc: "Fix technical issues, improve site speed, mobile-friendliness, and crawlability.",
  },
  {
    id: "content-seo",
    title: "Content SEO",
    desc: "Create SEO-optimized content that ranks high and converts visitors.",
  },
  {
    id: "link-building",
    title: "Link Building",
    desc: "Build high-quality backlinks from authoritative websites for domain authority.",
  },
  {
    id: "local-seo",
    title: "Local SEO",
    desc: "Dominate local search results with Google My Business optimization.",
  },
  {
    id: "seo-audit",
    title: "SEO Audits",
    desc: "Comprehensive site audits to identify and fix SEO issues.",
  },
];

const benefits = [
  { title: "Long-Term Growth", desc: "Build sustainable organic traffic that grows over time" },
  { title: "Cost-Effective", desc: "Reduce customer acquisition costs compared to paid ads" },
  { title: "High Trust", desc: "Organic results have higher click-through rates and trust" },
  { title: "Competitive Edge", desc: "Outrank competitors on keywords that matter" },
  { title: "Brand Authority", desc: "Establish your brand as an industry authority" },
  { title: "Passive Traffic", desc: "Continuous traffic generation without ongoing ad spend" },
];
  ...
  return (
    <div className="w-full bg-black text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block rounded-full px-4 py-1 text-sm font-medium" style={{ background: `${COLORS.secondary}33`, color: COLORS.white }}>
              Organic Growth • Sustainable • Authority
            </div>

            <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">
              Achieve Organic Growth{" "}
              <span style={{ color: COLORS.primary }}>Through Expert SEO</span>
            </h1>

            <p className="mt-4 text-lg text-gray-300 max-w-2xl">
              Achieve top rankings in Google with our comprehensive SEO services. Sustainable organic traffic that keeps growing over time.
            </p>
          ...
          <div className="rounded-2xl p-6" style={{ background: COLORS.card }}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="border border-[rgba(255,255,255,0.04)] rounded-lg p-4">
                ...
                <div className="text-xs text-gray-400">Keywords Ranked</div>
              </div>
              <div className="border border-[rgba(255,255,255,0.04)] rounded-lg p-4">
            ...
            <div className="mt-6">
              <p className="text-sm text-gray-300">Ready to rank higher?</p>
      ...
      <section className="py-20 md:py-28" style={{ background: `${COLORS.secondary}11` }}>
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mb-16">
            <h2 className="text-4xl md:text-5xl font-bold">Why SEO Works</h2>
          </div>
      ...
      <section className="py-20 md:py-28" style={{ background: COLORS.bg }}>
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let our SEO experts help you achieve top rankings and sustainable organic growth.
          </p>
          <Link
            to="/contact"
