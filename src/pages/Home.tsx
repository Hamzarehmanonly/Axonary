  ...
  return (
    <div className="relative w-full bg-black overflow-hidden">
      ...
      <div className="relative h-screen">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-[#000000] via-[#1a1025] to-[#261540] opacity-80"
          style={{
      ...
      <div
        ref={featuresRef}
        className="relative min-h-screen py-24 bg-gradient-to-b from-[#000000] to-[#0F0A1A]"
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={`feature-${index}`}
                className={`bg-[#0F0A1A] border border-[#5C3693]/20 rounded-xl p-6 transition-all duration-700 transform ${isInViewport(featuresRef)
      ...
      <div
        ref={testimonialsRef}
        className="relative min-h-screen py-24 bg-[#080510]"
      >
        {/* Parallax grid lines */}
        <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div
                ...
                className={`bg-gradient-to-br from-[#0F0A1A] to-[#1A1025] border border-[#5C3693]/20 rounded-xl p-8 transition-all duration-700 transform ${isInViewport(testimonialsRef)
                    ? 'opacity-100 translate-y-0'
                    : 'opacity-0 translate-y-12'
                  }`}
                style={{ transitionDelay: `${index * 100}ms` }}
      ...
      <div
        ref={platformsRef}
        className="relative min-h-screen py-24 bg-gradient-to-b from-[#080510] to-[#000000]"
      >
        {/* Decorative elements */}
            ...
            {[
              ...
              <div
                ...
                className={`group relative border border-[#5C3693]/20 rounded-xl transition-all duration-500 ${platform.popular
                    ? 'bg-gradient-to-b from-[#261540] to-[#110A25]'
                    : 'bg-[#0A0814] hover:bg-[#110A25]'
