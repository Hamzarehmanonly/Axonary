        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="inline-block">
              <span className="text-2xl font-bold text-white">AXONARY</span>
            </Link>
            <p className="text-gray-400 max-w-md">
              Creating exceptional digital experiences that drive growth and innovation. We transform ideas into powerful digital solutions.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-[#5C3693]/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex flex-wrap justify-center md:justify-end gap-4 md:gap-6">
              <Link
                to="/privacypolicy"
                className="text-gray-400 hover:text-[#5C3693] text-sm transition-colors duration-300"
              >
                Privacy Policy
              </Link>
              <Link
